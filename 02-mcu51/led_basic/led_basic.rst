      ...
      000003 02 00 86         [24]  301 	ljmp	_main
                                    ...
                                    306 	.area CSEG    (CODE)
                                    307 ;------------------------------------------------------------
                                    308 ;Allocation info for local variables in function 'delayms'
                                    309 ;------------------------------------------------------------
                                    310 ;xms                       Allocated to registers 
                                    311 ;i                         Allocated to registers r6 r7 
                                    312 ;j                         Allocated to registers r4 r5 
                                    313 ;------------------------------------------------------------
                                    314 ;	led_basic.c:3: void delayms(unsigned int xms)
                                    315 ;	-----------------------------------------
                                    316 ;	 function delayms
                                    317 ;	-----------------------------------------
      000062                        318 _delayms:
                           000007   319 	ar7 = 0x07
                           000006   320 	ar6 = 0x06
      ...
      000064 AF 83            [24]  328 	mov	r7,dph
                                    329 ;	led_basic.c:6: for (i = xms; i > 0; i--)
      000066                        330 00106$:
      000066 EE               [12]  331 	mov	a,r6
      000067 4F               [12]  332 	orl	a,r7
      000068 60 1B            [24]  333 	jz	00108$
                                    334 ;	led_basic.c:7: for (j = 70; j > 0; j--)
      00006A 7C 46            [12]  335 	mov	r4,#0x46
      00006C 7D 00            [12]  336 	mov	r5,#0x00
      00006E                        337 00104$:
      00006E EC               [12]  338 	mov	a,r4
      00006F 24 FF            [12]  339 	add	a,#0xff
      000071 FA               [12]  340 	mov	r2,a
      000072 ED               [12]  341 	mov	a,r5
      000073 34 FF            [12]  342 	addc	a,#0xff
      000075 FB               [12]  343 	mov	r3,a
      000076 8A 04            [24]  344 	mov	ar4,r2
      000078 8B 05            [24]  345 	mov	ar5,r3
      00007A EA               [12]  346 	mov	a,r2
      00007B 4B               [12]  347 	orl	a,r3
      00007C 70 F0            [24]  348 	jnz	00104$
                                    349 ;	led_basic.c:6: for (i = xms; i > 0; i--)
      00007E 1E               [12]  350 	dec	r6
      00007F BE FF 01         [24]  351 	cjne	r6,#0xff,00133$
      000082 1F               [12]  352 	dec	r7
      000083                        353 00133$:
      000083 80 E1            [24]  354 	sjmp	00106$
      000085                        355 00108$:
                                    356 ;	led_basic.c:9: }
      000085 22               [24]  357 	ret
                                    ...
                                    360 ;------------------------------------------------------------
                                    361 ;	led_basic.c:11: void main(){
                                    362 ;	-----------------------------------------
                                    363 ;	 function main
                                    364 ;	-----------------------------------------
      000086                        365 _main:
                                    366 ;	led_basic.c:12: P2_0 = 1;
                                    367 ;	assignBit
      000086 D2 A0            [12]  368 	setb	_P2_0
                                    369 ;	led_basic.c:13: P2_1 = 1;
                                    370 ;	assignBit
      000088 D2 A1            [12]  371 	setb	_P2_1
                                    372 ;	led_basic.c:14: P2_2 = 0;
                                    373 ;	assignBit
      00008A C2 A2            [12]  374 	clr	_P2_2
                                    375 ;	led_basic.c:16: P2_3 = 1;
                                    376 ;	assignBit
      00008C D2 A3            [12]  377 	setb	_P2_3
                                    378 ;	led_basic.c:17: P2_4 = 1;
                                    379 ;	assignBit
      00008E D2 A4            [12]  380 	setb	_P2_4
                                    381 ;	led_basic.c:18: P2_5 = 0;
                                    382 ;	assignBit
      000090 C2 A5            [12]  383 	clr	_P2_5
                                    384 ;	led_basic.c:19: while(1) {
      000092                        385 00102$:
                                    386 ;	led_basic.c:21: }
      000092 80 FE            [24]  387 	sjmp	00102$
                                    388 	.area CSEG    (CODE)
                                    389 	.area CONST   (CODE)
                                    390 	.area XINIT   (CODE)
