...
--------------------------------------------------------
`2 现代计算机架构及网络 <04-computor-system>`_
--------------------------------------------------------

--------------------------------------------------------
`3 操作系统 <05-operation-system>`_
--------------------------------------------------------
...
--------------------------------------------------------
`1 程序语言 <06-programming-language>`_
--------------------------------------------------------

--------------------------------------------------------
`2 数据结构和算法 <07-data-structure-algorithm>`_
--------------------------------------------------------

--------------------------------------------------------
`3 软件架构设计 <08-software-architecture>`_
--------------------------------------------------------

--------------------------------------------------------
`4 编译原理 <09-compiler>`_
--------------------------------------------------------

--------------------------------------------------------
`5 软件工程及经典软件解析 <10-software-analysis>`_
--------------------------------------------------------
...
--------------------------------------------------------
`1 机器学习与视频图像处理 <11-machine-learning>`_
--------------------------------------------------------

------------------------------------------
`2 机器人&机械臂 <12-roboot>`_
------------------------------------------

哲学/心理学
===========================
--------------------------------------------------------
`1 古典哲学学习总结 <13-philosophy>`_
--------------------------------------------------------
